...
<section className="px-6 py-20 bg-zinc-900">
  ...
  <div className="max-w-4xl mx-auto text-center">
    ...
    <p className="text-zinc-300 mb-10 leading-8">
      ...
      必要情報と写真を送信するだけでLINE、メール査定、
      <br />

      電話・メールでのご相談も受付しています。<br />
「LINE査定」を押していただき、公式アカウントに登録して査定希望を押していただければ教えていただきたい<br />
情報等が自動で返信されてきますのでそちらに従って返信をよろしくお願いします。<br />
下の「メールで無料相談」でしたら必要情報を入力するページに移動しますのでそちらから入力をいただいて送信でも大丈夫です。<br />
      <br />
